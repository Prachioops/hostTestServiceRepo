...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring Web Services, Spring for Apache ActiveMQ Artemis, Spring Integration, Eureka Server'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 hostTestService:0.0.1-SNAPSHOT
```
